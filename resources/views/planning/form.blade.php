@isset($typeForm)
    @if($typeForm == "create")
        {!! Form::open(['url' => route('plannings.store'), 'class' => 'needs-validation', 'novalidate']) !!}
        <div class="modal-body">
            ...
            @for ($i = 1; $i <= \Carbon\Carbon::parse($bilan->dateFin)->diffInDays($bilan->dateDebut); $i++)
                ...
                <div class="form-group row justify-content-center">
                    {!! Form::label('absent', 'Absent', ['class' => 'col-lg-2 col-form-label']) !!}
                    <div class="col-lg-6">
                        {!! Form::select('absent', ['0' => 'aucune absence', '1' => 'matin', '2' => 'après-midi', '3' => 'matin et après-midi'], '0', ['class' => 'form-control']) !!}
                        <div class="invalid-feedback">
                            Saisir un nom
                        </div>
                    </div>
                ...
                <div class="form-group row justify-content-center">
                    {!! Form::label('retard', 'Retard', ['class' => 'col-lg-2 col-form-label']) !!}
                    <div class="col-lg-6">
                        {!! Form::select('retard', ['0' => 'aucun retard', '1' => 'matin', '2' => 'après-midi', '3' => 'matin et après-midi'], '0', ['class' => 'form-control']) !!}
                        <div class="invalid-feedback">
                            Saisir un nom
                        </div>
                    </div>
